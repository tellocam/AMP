...
\newcommand{\secondauthorfirstname}{Manuela }
\newcommand{\secondauthorlastname}{Raidl }

\newcommand{\doctitle}{Programming Project}
...
% header inputs
\lhead[even output]{AMP}
\chead[even output]{Programming Project}
\rhead[even output]{\includegraphics[width=2.5cm]{figures/uni_header}}


%footer inputs
\lfoot[even output]{CSE - SS23}
...
\hypersetup{pdfinfo={
Title={\doctitle},
Subject={Advanced Multiprocessor Programming},
Author={Camilo Tello Fachin, Manuela Raidl and Iris Grze},
Keywords={OpenMP, }{C Language, }{Hardware Supported Locks, }{Summer Semester 23, }
